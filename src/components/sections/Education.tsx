  ...
  return (
    <section id="education" className="section" aria-labelledby="education-heading">
      <SectionHeader
        ...
        title="Education"
        description="Academic background that shaped my approach to AI systems and data products."
      />
          ...
          <div className="relative">
            ...
            <div className="space-y-12">
              {education.map((item, index) => {
                ...
                return (
                  <div key={`${item.degree}-${item.institution}`} className="relative pl-10">
                    <span
                    ...
                    <ul className="space-y-2.5 mb-6" role="list">
                      {item.highlights.map((highlight) => (
                        <li key={highlight} className="flex items-start gap-3 text-sm text-muted/80">
                          <span
                    ...
                    <div className="flex flex-wrap gap-2" role="list" aria-label="Subjects studied">
